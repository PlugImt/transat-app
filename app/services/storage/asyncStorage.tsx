...
import type { StorageItem, StorageItemValue, StorageService } from "./types";
...
class AsyncStorageService implements StorageService {
   ...
   */
  async multiGet(keys: string[]): Promise<Array<[string, StorageItemValue]>> {
    try {
   ...
   */
  async multiSet(
    keyValuePairs: Array<[string, StorageItemValue]>,
  ): Promise<boolean> {
    try {
