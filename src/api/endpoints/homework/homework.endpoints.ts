...
export const getHomeworks = async (userId: number): Promise<Homework[]> => {
    ...
    return [
        ...
        },
        {
            ...
            description: "Rédiger une critique du texte de Kant sur la morale. Rédiger une critique du texte de Kant sur la morale. Rédiger une critique du texte de Kant sur la morale. Rédiger une critique du texte de Kant sur la morale.",
