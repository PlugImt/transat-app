...
const Button = ({
    ...
    return (
        <TouchableOpacity
            ...
            className={cn(className, 'rounded-lg gap-1 flex-row items-center justify-center')}
            {...props}
            disabled={isDisabled}
            onPress={handlePress}
        >
...
const IconButton = ({
    ...
    return (
        <TouchableOpacity
            ...
            className={cn(className, 'rounded-full aspect-square items-center justify-center')}
            disabled={isDisabled}
            {...props}
            onPress={handlePress}
        >
