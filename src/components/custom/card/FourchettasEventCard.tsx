...
const FourchettasEventCard = ({
  ...
  return (
    ...
    >
      ...
      <Text variant="lg" className="text-center">{description}</Text>
    <Text variant="sm" className="text-center">Le {date} à {time}</Text>
    <Text variant="sm" className="text-center">Clôture des commandes le {form_closing_date} à {form_closing_time}</Text>
    <Button label={t("services.fourchettas.orderButton")}
    onPress={onPress} />
    </View>
  );
};
...
export const FourchettasEventCardLoading = () => {
  ...
  return (
    ...
    >
      <TextSkeleton className="w-20 h-20 rounded-lg" />
    </View>
  );
};
